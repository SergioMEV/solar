...
{
  if (file_content->line_capacity == file_content->line_size)
  {
  ...
  file_content->file_content_head[file_content->line_size++] = new_line;
}
...
{
  for (size_t line_index = 0; line_index < file_content->line_size; line_index++)
  {
